...
cat <<EOF
  ...
  .eh_frame     ${RELOCATING-0} : ONLY_IF_RO { KEEP (*crtbegin.o(.eh_frame))${RELOCATING+ *(.eh_frame.*)} KEEP (*(.eh_frame)) }
  ...
  /* Exception handling  */
  .eh_frame     ${RELOCATING-0} : ONLY_IF_RW { KEEP (*crtbegin.o(.eh_frame))${RELOCATING+ *(.eh_frame.*)} KEEP (*(.eh_frame)) }
