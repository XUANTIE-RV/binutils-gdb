...
#undef DECLARE_CSR
  ...
  RISCV_M0_REGNUM = RISCV_V31_REGNUM + 1,

  RISCV_M7_REGNUM = RISCV_M0_REGNUM + 7,

  RISCV_LAST_REGNUM = RISCV_M7_REGNUM
};
...
enum
{
  ...
  RISCV_DWARF_REGNUM_M0 = 3072,
  RISCV_DWARF_REGNUM_M7 = 3079,
